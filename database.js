...
app.post('/updatemasteroptiongroup', function (req, res) {
    console.dir('/updatemasteroptiongroup',req.body);
...
app.post('/updatevariantgroup', function (req, res) {
    console.dir('/updatevariantgroup',req.body);
    db.masteroptiongroupdb.update({ _id: req.body._id }, req.body, { upsert: true }, function (err, newDoc) {
        console.log(newDoc) // Callback is optional
        res.send({ message: 'yes iam the server' })
    });
...
//     service: 'gmail',
//     auth: {
//         user: process.env.EMAIL || 'vj.ns.2505@gmail.com', // TODO: your gmail account 
//         pass: process.env.PASSWORD || 'Vijay@2505' // TODO: your gmail password
//     }
// });
...
function send_mail() {
    ...
    let transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: process.env.EMAIL || 'bizdom.solutions@gmail.com', // TODO: your gmail account 
            pass: process.env.PASSWORD || 'Password@123' // TODO: your gmail password
        }
    });

    // Step 2
    let mailOptions = {
        from: 'bizdom.solutions@gmail.com', // TODO: email sender
        to: 'professor.vj.2505@gmail.com', // TODO: email receiver
        subject: 'Nodemailer - Test',
        text: 'Wooohooo it works!!Wellcome to Fun Of Heuristic 👻',
        attachments: [
