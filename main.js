...
global.barcodePrint = function (options, data) {
  ...
  //   timeOutPerLine: 5000,
  //   silent: true,
  //   pageSize: { height: 20000, width: 50000 }  // page size
  // }
  // const data = [{
  //   type: 'barCode',                // 'text' | 'barCode' | 'qrCode' | 'image' | 'table
  //   value: barcode,
  //   height: 100,                     // height of barcode, applicable only to bar and QR codes
  //   width: 18,                       // width of barcode, applicable only to bar and QR codes
